...
scrapeFailures =
    with (pushd "scraper") $ \() -> do
        ...
        shells "stack exec scraper -- merge  --kiegroup-dir=/home/hrk/Devel/github.com/jhrcek/kiegroup-all --archived-report=../failures.json --new-report=new-failures.json --output=../frontend/dist/failures.json" empty
